    ...
    <div className="gt-login">
      ...
      <div className="gt-card">
        <div className="gt-card-inner">
          ...
          {step === "form" && (
            <>
              <div className="gt-fields">
                <input className="gt-input" type="email" placeholder="votre@email.com" value={email} onChange={(e) => setEmail(e.target.value)} />
                <input className="gt-input" type={showPwd ? "text" : "password"} placeholder="Mot de passe" value={pwd} onChange={(e) => setPwd(e.target.value)} />
                <input className="gt-input" type={showPwd ? "text" : "password"} placeholder="Confirmer mot de passe" value={confirmPwd} onChange={(e) => setConfirmPwd(e.target.value)} />
                <span onClick={() => setShowPwd(v => !v)} style={{cursor:'pointer', position:'absolute', right:'40px', marginTop:'-35px'}}>👁</span>
              </div>
          ...
          {step === "verify" && (
            <div className="gt-fields">
              <p className="gt-sub">Code envoyé à <b>{email}</b></p>
              <input className="gt-input" placeholder="Entrer le code" value={code} onChange={(e) => setCode(e.target.value)} />
